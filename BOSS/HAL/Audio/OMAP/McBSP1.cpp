 ...
 */
void McBSP1::init_mcbsp1() {
// Programming Model page 2050
...
// Hardware and Software Reset
	...
	unsetBit( (address) (MCBSP1_BASE + MCBSPLP_SPCR2_REG), MCBSP_FRST_BIT);
	unsetBit( (address) (MCBSP1_BASE + MCBSPLP_SPCR2_REG), MCBSP_XRST_BIT);
	// set the receiver in reset mode (needed to configure) page 2086
	unsetBit( (address) (MCBSP1_BASE + MCBSPLP_SPCR1_REG), MCBSP_RRST_BIT);

	// Schwarze Magie
	*((address)0x4800218C) = 0x1C0118;
	*((address)0x48002190) = 0x1180004;

	//-> This should be the new value: 0000 0001 0001 1000
	//                                 0000 0001(->Input Enabled) 0001 (-> PullUp-Selected) 1(->PullUp) 000
	//-> The old value in the Register should not be deleted

//	//	RCR1
//	setBit( (address) (MCBSP1_BASE + MCBSPLP_RCR1_REG), MCBSP_WDLEN_16_BIT); 	// 16-bit word length for phase 1
//	setBit( (address) (MCBSP1_BASE + MCBSPLP_RCR1_REG), RFRLEN2_BIT);			// framelength = 1 word
//
//	// RCR2
//	setBit( (address) (MCBSP1_BASE + MCBSPLP_RCR2_REG), RPHASE_DUAL_BIT); 		// 2 phase
//	setBit( (address) (MCBSP1_BASE + MCBSPLP_RCR2_REG), RDATDLY_ONE_BIT);		// delay of 1 ms for i2s page
//	unsetBit( (address) (MCBSP1_BASE + MCBSPLP_RCR2_REG), RFRLEN2_BIT);			// framelength = 1 word
//	setBit( (address) (MCBSP1_BASE + MCBSPLP_RCR2_REG), MCBSP_WDLEN_16_BIT);	//
...
//	setBit( (address) (MCBSP1_BASE + MCBSPLP_SPCR2_REG), MCBSP_FRST_BIT);
	setBit( (address) (MCBSP1_BASE + MCBSPLP_SPCR2_REG), MCBSP_XRST_BIT);
	// wake up the receiver of reset mode (needed to configure) page 2086
	setBit( (address) (MCBSP1_BASE + MCBSPLP_SPCR1_REG), MCBSP_RRST_BIT);
}
