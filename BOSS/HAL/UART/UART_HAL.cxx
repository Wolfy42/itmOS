...
void uart_reset(mem_address_t* uart_base_addr) {
 ...
 void uart_switch_lcr_mode(mem_address_t* uart_base_addr,
 ...
 */
 void uart_set_protocol_data_len(mem_address_t* uart_base_addr,
                                       unsigned short len) {
 ...
 void uart_set_protocol_stop_bit(mem_address_t* uart_base_addr,
 ...
 void uart_set_protocol_parity(mem_address_t* uart_base_addr,
                                     unsigned int parity) {
